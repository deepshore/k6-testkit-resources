...
export default function testSuite() {
  ...
  describe('04. Create a new document', (t) => {
    let payload = {
      name: `Croc Name`,
      sex: randomItem(["M", "F"]),
  ...
  describe('05. Fetch private documents', (t) => {
  ...
  describe('06. Update the document', (t) => {
    let payload = {
      name: `New name`,
    };
  ...
  describe('07. Delete the document', (t) => {
